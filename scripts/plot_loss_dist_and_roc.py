...
sample_qcd = jesa.JetSample.from_input_file(name=params.sample_id_qcd, path='/eos/user/k/kiwoznia/data/laspaclu_results/run_11/qcdSig.h5')
sample_sig = jesa.JetSample.from_input_file(name=params.sample_id_sig, path='/eos/user/k/kiwoznia/data/laspaclu_results/run_11/GtoWW35na.h5')
