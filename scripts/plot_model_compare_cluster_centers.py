...
centroids.append(centroids_quantum, ignore_index=True)
centroids['label'] = ['classic']*2 +['quantum']*2
...
plt.tight_layout()
plt.show()
plot.savefig(fig_dir+'/center_pair_scatter_classic_vs_quantum.png')
