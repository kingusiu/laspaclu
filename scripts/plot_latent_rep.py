...
params = Parameters(run_n=50, read_n=int(1e5))
...
sns.move_legend(plot1, bbox_to_anchor=(0.5, -0.05), loc="lower center", ncol=2, labelspacing=0.8, fontsize=18, title='Samples', title_fontsize='18')
plt.tight_layout()
...
sns.move_legend(plot1, bbox_to_anchor=(0.5, -0.05), loc="lower center", ncol=2, labelspacing=0.8, fontsize=18, title='Samples', title_fontsize='18')
plt.tight_layout()
plot2.savefig(fig_dir+'/latent_pair_scatter_'+sample_id_qcd+'_vs_'+sample_id_sig+'_j2.png')
